...
* **The Metrictank project**: The sum of all activities performed under this governance, concerning one or more repositories or the community.

## Values

The Metrictank developers and community are expected to follow the values defined in the [Code of Conduct][coc]. Furthermore, the Metrictank community strives for kindness, giving feedback effectively, and building a welcoming environment. The Metrictank developers generally decide by consensus and only resort to conflict resolution by a majority vote if consensus cannot be reached.

## Projects

Each project must have a [`MAINTAINERS.md`][maintainers] file with at least one maintainer. Where a project has a release process, access and documentation should be such that more than one person can perform a release. Releases should be announced on the [dev][devs] mailing lists. Any new projects should be first proposed on the [team mailing list][team] following the voting procedures listed below.
...
The Metrictank project usually runs by informal consensus, however sometimes a formal decision must be made.
...
The default decision making mechanism for the Metrictank project is [rough][rough] consensus. This means that any decision on technical issues is considered supported by the [team][team] as long as nobody objects or the objection has been considered but not necessarily accommodated.
...
[coc]: https://github.com/grafana/metrictank/blob/master/CODE_OF_CONDUCT.md
[devs]: https://groups.google.com/forum/#!forum/metrictank-developers
[maintainers]: https://github.com/grafana/metrictank/blob/master/MAINTAINERS.md
[rough]: https://tools.ietf.org/html/rfc7282
[team]: https://groups.google.com/forum/#!forum/metrictank-team
