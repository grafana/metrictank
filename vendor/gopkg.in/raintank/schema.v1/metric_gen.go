...
// DecodeMsg implements msgp.Decodable
func (z *MetricPointId1) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *MetricPointId1) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 3
	// write "Id"
	err = en.Append(0x83, 0xa2, 0x49, 0x64)
	if err != nil {
...
// MarshalMsg implements msgp.Marshaler
func (z *MetricPointId1) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 3
	// string "Id"
	o = append(o, 0x83, 0xa2, 0x49, 0x64)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *MetricPointId1) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *MetricPointId1) Msgsize() (s int) {
	s = 1 + 3 + msgp.ArrayHeaderSize + (16 * (msgp.ByteSize)) + 5 + msgp.Uint32Size + 6 + msgp.Float64Size
	return
}

// DecodeMsg implements msgp.Decodable
func (z *MetricPointId2) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
func (z *MetricPointId2) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 4
	// write "Org"
	err = en.Append(0x84, 0xa3, 0x4f, 0x72, 0x67)
	if err != nil {
		return
	}
...
func (z *MetricPointId2) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 4
	// string "Org"
	o = append(o, 0x84, 0xa3, 0x4f, 0x72, 0x67)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *MetricPointId2) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
func (z *MetricPointId2) Msgsize() (s int) {
	s = 1 + 4 + msgp.Uint32Size + 3 + msgp.ArrayHeaderSize + (16 * (msgp.ByteSize)) + 5 + msgp.Uint32Size + 6 + msgp.Float64Size
	return
}
