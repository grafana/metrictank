...
type MetricDefinition struct {
	...
	// this is a special attribute that does not need to be set when storing
	// the struct or sending it over the network. the content of NameWithTags
	// can be generated by calling the method DeduplicateNameWithTags().
