...
Note that Grafana Metrictank simply logs to stdout.
...
* [Grafana Metrictank dashboard](https://grafana.net/dashboards/279): visualizes all Grafana Metrictank's internal performance metrics, which it sends via statsd/statsdaemon, into itself.  This dashboard will not work if you disabled statsd.
