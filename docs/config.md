...
# to prevent gaps in charts, or have a long kafka backfill process
# for query nodes, this is helpful to control how long you can wait before gossip to settle
warm-up-period = 1h
