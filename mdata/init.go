...
var (
	...
	chunkCreate = stats.NewCounter32("chunks.create")
	chunkClear  = stats.NewCounter32("chunks.clear")
	...
	metricsTooOld = stats.NewCounter32("metrics_too_old")
	...
	addToSavingChunk = stats.NewCounter32("add_to_saving_chunk")
