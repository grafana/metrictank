	...
	for zb0001 > 0 {
		...
		case "Tags":
			...
			if cap(z.Tags) >= int(zb0003) {
				...
				z.Tags = make(TagKeyValues, zb0003)
			}
...
func (z *MetricDefinition) EncodeMsg(en *msgp.Writer) (err error) {
	...
	// write "Name"
	// map header, size 0
	err = en.Append(0xa4, 0x4e, 0x61, 0x6d, 0x65, 0x80)
	if err != nil {
		return
	}
	// write "Interval"
...
func (z *MetricDefinition) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// string "Name"
	// map header, size 0
	o = append(o, 0xa4, 0x4e, 0x61, 0x6d, 0x65, 0x80)
	// string "Interval"
...
func (z *MetricDefinition) Msgsize() (s int) {
	s = 1 + 3 + z.Id.Msgsize() + 6 + msgp.Uint32Size + 5 + 1 + 9 + msgp.IntSize + 5 + msgp.StringPrefixSize + len(z.Unit) + 5 + msgp.ArrayHeaderSize
	for za0001 := range z.Tags {
