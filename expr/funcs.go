...
func init() {
	...
	funcs = map[string]funcDef{
		...
		"diff":           {NewAggregateConstructor("diff", crossSeriesDiff), true},
		...
		"multiply":       {NewAggregateConstructor("multiply", crossSeriesMultiply), true},
		...
		"rangeOf":        {NewAggregateConstructor("rangeOf", crossSeriesRange), true},
		"rangeOfSeries":  {NewAggregateConstructor("rangeOf", crossSeriesRange), true},
		"scale":          {NewScale, true},
		"smartSummarize": {NewSmartSummarize, false},
		"stddev":         {NewAggregateConstructor("stddev", crossSeriesStddev), true},
