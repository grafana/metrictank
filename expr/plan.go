...
type Plan struct {
	...
	dataMap       map[Req][]models.Series // input data to work with. set via Run(), as well as
...
func (p Plan) Run(dataMap map[Req][]models.Series) ([]models.Series, error) {
